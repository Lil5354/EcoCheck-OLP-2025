...
import { MdOutlineDashboard, MdOutlineMap, MdOutlineAnalytics, MdOutlineRoute, MdSettings, MdLocalShipping, MdPeopleAlt, MdWarehouse, MdWarningAmber, MdCalendarToday } from 'react-icons/md'
...
const groups = [
  ...
  },
  {
    title: 'VẬN HÀNH',
    items: [
      { to: '/operations/schedules', label: 'Lịch thu gom', icon: <MdCalendarToday /> },
