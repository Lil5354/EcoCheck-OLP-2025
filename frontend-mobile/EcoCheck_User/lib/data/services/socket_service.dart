...
class SocketService {
  ...
  final _scheduleUpdatedController = StreamController<Map<String, dynamic>>.broadcast();
  final _scheduleCompletedController = StreamController<Map<String, dynamic>>.broadcast();
  final _pointsEarnedController = StreamController<Map<String, dynamic>>.broadcast();

  bool get isConnected => _isConnected;
  
  // Streams
  Stream<Map<String, dynamic>> get scheduleUpdated => _scheduleUpdatedController.stream;
  Stream<Map<String, dynamic>> get scheduleCompleted => _scheduleCompletedController.stream;
  Stream<Map<String, dynamic>> get pointsEarned => _pointsEarnedController.stream;
