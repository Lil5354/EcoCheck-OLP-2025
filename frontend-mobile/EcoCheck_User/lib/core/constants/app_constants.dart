...
class AppConstants {
  ...
  // Achievements Thresholds (kg)
  static const double bronzeBadge = 50;
  static const double silverBadge = 100;
  static const double goldBadge = 500;
  static const double platinumBadge = 1000;

  // Points System
  static const int pointsPerKg = 10;
  static const double co2SavedPerKg = 0.5; // kg CO2 per kg waste
